...
class CreateClientCFG():
    ...
    def __init__(self, file_name="test_client.cfg", application_id="client", connection_type="initiator",
                    file_store_path="storage/client_messages", file_log_path="log/client_log", start_time="00:01:00",
                    end_time="23:59:00", heart_bt_int="30",
