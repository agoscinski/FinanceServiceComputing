...
class ServerLogic:
    ...
    def process_market_data_request(self, md_request):
        ...
        self.pack_into_fix_market_data_response(open_stock_orders, stock_information)
    ...
    def pack_into_fix_market_data_response(self, open_stock_orders, stock_information):
...
class ServerDatabaseHandler:
    ...
    def fetch_stock_information(self, stock_ticker_symbol):
        ...
        order_arguments_rows = self.execute_select_sql_command(sql_command)
        database_stock_information = TradingClass.DatabaseStockInformation(current_price = None, current_volume = None, opening_price = None, closing_price = None, day_high = None, day_low)
