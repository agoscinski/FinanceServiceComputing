...
class ServerLogic:
    ...
    def process_valid_order_cancel_request(self, requested_order_cancel, order):
        ...
        """
        self.server_database_handler.update_order_status(order, LastStatus.CANCELED)
        ...
        order_cancel_execution = ExecutionReport(order_id, cl_ord_id, exec_id, exec_trans_type, exec_type,
                        ord_status, symbol, side, leaves_qty, cum_qty, avg_px, price, receiver_comp_id, orig_cl_ord_id)
